...
def create_index():
    ...
    subprocess.call(['java', '-jar', dir_name + '/java-code/executable/indexengine.jar', create_index_cmd])
...
def search_per_content():
    ...
    search = subprocess.Popen(['java', '-jar', dir_name + '/java-code/executable/indexengine.jar',
